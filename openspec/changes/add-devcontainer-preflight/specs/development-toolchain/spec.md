...
<!-- A MODIFIED requirement carries the whole block, copied from
     openspec/specs/development-toolchain/spec.md. Four passive constructions
     come with that copy. Rewriting them here would change requirement text
     this change does not touch, and archive would then write the rewrite into
     the main spec. -->
