...
- Those two actors match the ones who may already open a test instance. The claim rule now follows the read rule.
...
- `docs/openapi.yaml` and `docs/current-state.md`: the claim route's refusal text, and the draft test instances section.
