...
The studio's area nav SHALL carry four controls. Those are Checks, Save,
Discard draft and Publish. The header bar's own menu SHALL carry none of the
four. The Checks control SHALL carry a dot and the open issue count. The dot SHALL read the worst open issue. One color marks a blocker, one
marks an advisory issue, and one marks a clear draft.
