...
describe("PanelsRailFieldRow", () => {
  ...
  // move (design.md, "Focus and the rail entry after an add into a group").
  // The id sits on the button, not the wrapper, so it lands on the same
  // element a click or a focus targets.
