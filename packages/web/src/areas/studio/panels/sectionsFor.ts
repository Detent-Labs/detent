...
const PARTICIPANT: SectionName[] = ["paths", "assignment", "entry", "exit", "timers", "form", "collaboration"];
 ...
 * wait-state with no participant form. A subprocess step carries no
 * Collaboration section either: it is an automatic wait-state with no
