...
export const en = {
  ...
  "ruleBuilder.addRow": "+ Add row",
  "ruleBuilder.removeRow": "Remove row",
  "ruleBuilder.and": "and",
  "ruleBuilder.operandLabel": "field",
  "ruleBuilder.operatorLabel": "operator",
  "ruleBuilder.selectOperand": "(select a field)",
  ...
  "ruleBuilder.valueLabel": "value",
  "ruleBuilder.valuePlaceholder": "value…",
  "ruleBuilder.selectValue": "(select a value)",
  "ruleBuilder.yes": "yes",
  "ruleBuilder.no": "no",
  "ruleBuilder.rawRow": "Written by hand. Edit it as CEL.",
  "ruleBuilder.incomplete": "Needs a value before it is written.",
  "ruleBuilder.celReadout": "Writes",
  "ruleBuilder.celEmpty": "nothing yet",
