 ...
 * of this package handles per-screen (TaskScreen's `withErrorHandling` +
...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  override componentDidCatch(error: Error, info: ErrorInfo): void {
    console.error("app: render-time error caught by ErrorBoundary", error, info.componentStack);
  }
  ...
  override render(): ReactNode {
    if (this.state.error) {
      ...
      return (
        <main className="app-boundary-fallback">
          <span className="app-boundary-stamp">{t(locale, "error.generic")}</span>
