...
import {
  ...
  handleCancel,
  handleRevokeVisibility,
  handleRestoreVisibility,
  handleGrantVisibility,
  handlePublish,
  handleListProcesses,
  handleListVersions,
} from "./routes.js";
import {
  ...
  handleAdminRenameGroup,
  handleAdminSetGroupMembers,
  handleAdminSetGroupScope,
  handleAdminDeleteGroup,
  handleAdminRunMigration,
  handleAdminRedactInstance,
  handleAdminListInstanceAudit,
  handleAdminVerifyInstanceAudit,
...
export function createServer(
  ...
  const routes: Route[] = [
    ...
    { method: "PUT", segments: seg("/instances/:instanceId/draft"),
      handler: (p, req, _c, db) => handleSaveInstanceDraft(p[0]!, req, resolver, db) },
    ...
    { method: "POST", segments: seg("/instances/:instanceId/visibility/revoke"),
      handler: (p, req, _c, db) => handleRevokeVisibility(p[0]!, req, resolver, db) },
    { method: "POST", segments: seg("/instances/:instanceId/visibility/restore"),
      handler: (p, req, _c, db) => handleRestoreVisibility(p[0]!, req, resolver, db) },
    { method: "POST", segments: seg("/instances/:instanceId/visibility/grant"),
      handler: (p, req, _c, db) => handleGrantVisibility(p[0]!, req, resolver, db) },
    ...
    { method: "GET", segments: seg("/admin/groups"),
      handler: (_p, req, _c, db) => handleAdminListGroups(req, resolver, db) },
    { method: "POST", segments: seg("/admin/groups"),
      handler: (_p, req, _c, db) => handleAdminCreateGroup(req, resolver, db) },
    { method: "PATCH", segments: seg("/admin/groups/:groupId/name"),
      handler: (p, req, _c, db) => handleAdminRenameGroup(p[0]!, req, resolver, db) },
    { method: "PATCH", segments: seg("/admin/groups/:groupId/members"),
      handler: (p, req, _c, db) => handleAdminSetGroupMembers(p[0]!, req, resolver, db) },
    { method: "PATCH", segments: seg("/admin/groups/:groupId/scope"),
      handler: (p, req, _c, db) => handleAdminSetGroupScope(p[0]!, req, resolver, db) },
    { method: "DELETE", segments: seg("/admin/groups/:groupId"),
      handler: (p, req, _c, db) => handleAdminDeleteGroup(p[0]!, req, resolver, db) },
    ...
    { method: "GET", segments: seg("/admin/instances/:instanceId/audit"),
      handler: (p, req, _c, db) => handleAdminListInstanceAudit(p[0]!, req, resolver, db) },
    { method: "GET", segments: seg("/admin/instances/:instanceId/audit/verify"),
      handler: (p, req, _c, db) => handleAdminVerifyInstanceAudit(p[0]!, req, resolver, db) },
    ...
    { method: "GET", segments: seg("/reporting/reports"),
      handler: (_p, req, _c, db) => handleListReports(req, resolver, db) },
    { method: "POST", segments: seg("/reporting/reports"),
      handler: (_p, req, _c, db) => handleCreateReport(req, resolver, db) },
    { method: "POST", segments: seg("/reporting/reports/preview"),
      handler: (_p, req, _c, db) => handlePreviewReport(req, resolver, db) },
    { method: "POST", segments: seg("/reporting/reports/columns"),
      handler: (_p, req, _c, db) => handleReportColumnChoices(req, resolver, db) },
    { method: "GET", segments: seg("/reporting/reports/:reportId"),
      handler: (p, req, _c, db) => handleGetReport(p[0]!, req, resolver, db) },
    { method: "PUT", segments: seg("/reporting/reports/:reportId"),
      handler: (p, req, _c, db) => handleUpdateReport(p[0]!, req, resolver, db) },
    { method: "DELETE", segments: seg("/reporting/reports/:reportId"),
    ...
    { method: "POST", segments: seg("/drafts/:processId/instances"),
      handler: (p, req, _c, db) => handleCreateTestInstance(p[0]!, req, resolver, dataSourceRegistry, db, assignmentRegistry) },
