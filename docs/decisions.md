...
2026-09-09. That review holds the reasoning and the recommended fix. The owner decided the other
five on 2026-09-23. See "Decided, not yet built" and "Accepted risks"
above. This section records that nothing else tracks the four still open.
